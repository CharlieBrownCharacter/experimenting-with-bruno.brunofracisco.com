        ...
        <SidebarGroupContent>
          <SidebarMenuItem>
            <SidebarMenuSubButton as-child>
              <RouterLink to="/">
                <FlaskConical />
                <span>Experimenting with Bruno</span>
              </RouterLink>
            </SidebarMenuSubButton>
          </SidebarMenuItem>
        </SidebarGroupContent>
            ...
            <SidebarMenuItem>
              ...
              <CollapsibleContent>
                <SidebarMenuSub>
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton as-child>
                      <RouterLink :to="{ name: 'textAnimations/WavyText' }">
                        <span>Wavy text</span>
                      </RouterLink>
                    </SidebarMenuSubButton>
                  </SidebarMenuSubItem>
                ...
                <SidebarMenuSub>
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton as-child>
                      <RouterLink :to="{ name: 'textAnimations/FollowCursorText' }">
            ...
            <SidebarMenuItem>
              ...
              <CollapsibleContent>
                <SidebarMenuSub>
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton as-child>
                      <RouterLink :to="{ name: 'cards/AnimateCardBorder' }">
